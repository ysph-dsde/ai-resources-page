...
Curated educational resource for AI/ML and Data Science available at Yale University or high-impact educational events/fellowships.

&nbsp;

![GitHub Repo stars](https://img.shields.io/github/stars/ysph-dsde/ai-resources-page) ![GitHub watchers](https://img.shields.io/github/watchers/ysph-dsde/ai-resources-page) ![GitHub forks](https://img.shields.io/github/forks/ysph-dsde/ai-resources-page) [![License: CC BY-NC 4.0](https://img.shields.io/badge/License-CC%20BY--NC%204.0-lightgrey.svg)](http://creativecommons.org/licenses/by-nc/4.0/)

![GitHub Issues or Pull Requests](https://img.shields.io/github/issues/ysph-dsde/ai-resources-page) ![GitHub Issues or Pull Requests](https://img.shields.io/github/issues-pr/ysph-dsde/ai-resources-page) ![GitHub Release Date](https://img.shields.io/github/release-date/ysph-dsde/ai-resources-page) ![GitHub repo size](https://img.shields.io/github/repo-size/ysph-dsde/ai-resources-page)

![GitHub contributors](https://img.shields.io/github/contributors/ysph-dsde/ai-resources-page) ![GitHub last commit](https://img.shields.io/github/last-commit/ysph-dsde/ai-resources-page) ![GitHub commit activity](https://img.shields.io/github/commit-activity/w/ysph-dsde/ai-resources-page) ![GitHub language count](https://img.shields.io/github/languages/count/ysph-dsde/ai-resources-page) ![GitHub top language](https://img.shields.io/github/languages/top/ysph-dsde/ai-resources-page)
