...
description: |
  ...
  Below is a curated list of common AI tools and links to Yale-provided tools, which are free for Yale affiliates and include additional security protections. Tools are organized by common use cases, with brief descriptions of how to best utilize them.
include-in-header: 
...
<style>
    ...
    .curation-table, .curation-table th, .curation-table td {
        border-bottom: 1px solid black;
    }
    .curation-table th, .curation-table td {
        padding: 10px;
    }
    .curation-table th {
        border-top: 2px solid black; /* Thicker top border for header cells */
        border-bottom: 2px solid black; /* Thicker bottom border for header cells */
        padding-top: 10px;
        padding-bottom: 10px;
        font-size: 1.2rem;
    }
    .curation-table .tool-name {
        width: 18%; /* Fixed width for the first column */
        text-align: right;
        font-weight: bold;
        margin-right: 2px;
    }
    .curation-table .at-yale {
        width: 12%; /* Fixed width for the first column */
        text-align: center;
        font-weight: bold;
    }
    .curation-table .description {
        text-align: left;
    }
    .curation-table tr:hover {
        background-color: #e0e0e0; /* Highlight color */
    }
    .curation-table tr:first-child:hover {
       background-color: transparent !important;
    }
    /* Thicker bottom border for the last row */
    .curation-table tr:last-child td {
...
<table class="curation-table">
    ...
    <!-- Row 2
    <tr>
        <td class="tool-name"><a href="https://github.com/features/copilot">Midjourney</a></td>
...
<table class="curation-table">
    ...
    <!-- Row 7
    <tr>
        <td class="tool-name"><a href="https://github.com/features/copilot">Manus</a></td>
        <td class="description"></td>
        <td class="at-yale">No</td>
    </tr> -->
    <!-- Row 8
    <tr>
        <td class="tool-name"><a href="https://github.com/features/copilot">ChatGPT Atlas</a></td>
        <td class="description"></td>
        <td class="at-yale">No</td>
    </tr> -->
</table>
...
<table class="curation-table">
    ...
    <!-- Row 4 
    Site was blocked by the firewall
    <tr>
